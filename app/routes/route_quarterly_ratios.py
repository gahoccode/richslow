...
async def get_quarterly_ratios(ticker: str = Path(..., description="Stock ticker symbol")):
    """
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to retrieve quarterly ratios: {str(e)}") from e