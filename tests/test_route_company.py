...
class TestCompanyEndpoints:
    ...
    def mock_company_news_data(self):
        ...
        return DataFrame({
            ...
            'title': ['VCB: Công bố đường dẫn BCTC riêng và HN Q1/2024', 'VCB: Cập nhật, bổ sung tài liệu họp ĐHĐCĐ'],
            'source': ['TCBS', 'TCBS'],
    ...
    @pytest.mark.parametrize("invalid_ticker", ["", "123", "TOOLONGTICKERNAME", "inv@lid"])
