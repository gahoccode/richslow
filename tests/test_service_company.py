...
class TestCompanyServiceFunctions:
        ...
        return DataFrame(
            {
                ...
                "company_profile": [
                    "Ngân hàng TMCP Ngoại thương Việt Nam là một trong những ngân hàng lớn nhất Việt Nam."
                ],
                "history_dev": [
                    "Tiền thân là Ngân hàng Ngoại thương Việt Nam được thành lập năm 1963."
                ],
                ...
                "business_strategies": [
                    "Tập trung vào bán lẻ và dịch vụ ngân hàng số."
                ],
            }
        )
        ...
        return DataFrame(
            {
                ...
                "event_name": [
                    "REE - Report Insider Transaction",
                    "REE - Public Release Q3 Financial Statement",
                    "REE - Dividend Payment",
                ],
                ...
                "event_desc": [
                    "Insider transaction details for Platinum Victory Pte. Ltd.",
        ...
        return DataFrame(
            {
                ...
                "title": [
                    "FPT: Public release on 9M2025 financial highlights",
    ...
    def test_get_company_overview_empty_data(self):
        ...
        with patch("app.services.service_company.TCBSCompany") as mock_company_class:
            ...
            with pytest.raises(
                ValueError, match="No overview data found for ticker VCB"
            ):
    ...
    def test_get_company_overview_api_exception(self):
        ...
        with patch("app.services.service_company.TCBSCompany") as mock_company_class:
            ...
            with pytest.raises(
                Exception, match="Failed to retrieve company overview for VCB"
            ):
                get_company_overview("VCB")
        ...
        mock_data = DataFrame(
            {
                ...
                "link": [
                    "https://example.com/q1_2024.pdf",
                    "https://example.com/annual_2023.pdf",
                ],
                "name": [
                    "Q1_2024_Financial_Report.pdf",
                    "Annual_2023_Financial_Report.pdf",
                ],
            }
        )
    ...
    def test_get_company_trading_stats_vci_empty_data(self):
        ...
        with patch("app.services.service_company.VCICompany") as mock_company_class:
            ...
            with pytest.raises(
                ValueError, match="No trading statistics found for ticker VCB"
            ):
